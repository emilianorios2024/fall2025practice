...
origin  git@github.com:emilianorios2024/fall2025practice.git (fetch)
origin  git@github.com:emilianorios2024/fall2025practice.git (push)
**Makefile**:
...
emiliano@agate:~/fall2025practice/f2025e1-a-master$ ./bin/orderlogs -f testcases/all_new
...
#0  0x0000555555555711 in find_news (node=0x7fffffffc3b8) at reorder.c:17
